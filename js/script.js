...
var insertProperty = function (html, randomCategoryShortName, chosenCategoryShortName) {
var propToReplace = "{{" + {{randomCategoryShortName}} + "}}";
string = string
.replace(new RegExp(randomCategoryShortName, "chosenCategoryShortName"), chosenCategoryShortName);
return string;
}
